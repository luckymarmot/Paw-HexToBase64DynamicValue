...
file = 'HexToBase64DynamicValue.coffee'
identifier = 'com.luckymarmot.PawExtensions.HexToBase64DynamicValue'
...
build_copy = () ->
    ...
    fs.writeFileSync "#{ build_dir }/b64.js", fs.readFileSync("./b64.js")
